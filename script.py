...
#append each new string to daily_transaction_split
...
for transactions in daily_transactions_split:
  for words in transactions:
    clean_transactions.append(words.strip())
...
customer_names = clean_transactions[::4]
sales = clean_transactions[1::4]
thread_sold = clean_transactions[2::4]


total_sales = 0

for sale in sales:
  total_sales = float(sale.strip("$")) + total_sales
